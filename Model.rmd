...
pred_test  <- predict(xgb_tune, test_data)

train_data<- train_data%>% 
  cbind (age_xgb=pred.train) %>% #[pred.train=age_xgb], thus age_xgb is HeartAge
...
train.bias <- predict (lin.mod, train_data$ca)
test.bias <- predict (lin.mod, test_data$ca)

# Bias-corrected HeartAge 
age_xgb_c_train <- (db_train$age_xgb - train.bias )
age_xgb_c_test <- (db_test$age_xgb - test.bias )
